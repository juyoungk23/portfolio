...
This turns a trust-based client handshake into a zero-trust architecture, which is table stakes for anyone streaming licensed sports content, whether that's me or the NBA.
