...
SHARP Memories is a cross-platform (web, iOS, visionOS) app that turns a single 2D photo into an immersive **3D Gaussian Splat** you can view and share on iOS, the web, and Apple Vision Pro.
...
I could have generated and stored the splats locally on-device, but the whole point was the moment someone "revives" a photo and immediately wants to show it to someone. So I designed around **distribution** and **retention** from the start.
