...
Apple's `GroupActivities` framework provides the bricks, not the house. I had to solve three distinct problems:
...
This turns a trust-based client handshake into a zero-trust architecture. If you're streaming licensed sports content, whether you're me or the NBA, you need this.
